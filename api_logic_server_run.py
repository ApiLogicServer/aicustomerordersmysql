...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.03.06, September 20, 2023 16:02:49):
...
app_logger.info(f'Created September 20, 2023 16:02:49 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.03.06\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.03.06\n'
    msg += f'.. startup message: {start_up_message}\n'
