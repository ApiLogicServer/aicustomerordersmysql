...
projectname="aicustomerordersmysql"  # lower case, only
resourcegroup="aicustomerordersmysql_rg"
...
# git clone https://github.com/apilogicserver/aicustomerordersmysql.git
# cd aicustomerordersmysql
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name aicustomerordersmysql --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
